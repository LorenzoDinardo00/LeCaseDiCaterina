...
const translationsIt = {
    ...
    fieldType: 'Tipo',
    fieldTypeValue: 'Affittacamere / Bed and Breakfast di lusso',
...
const translationsEn = {
    ...
    fieldType: 'Type',
    fieldTypeValue: 'Luxury rooms / Bed and Breakfast',
