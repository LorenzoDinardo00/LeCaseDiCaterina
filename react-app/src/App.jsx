    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer-legal">
          <p>Le Stanze di Caterina — Ditta Individuale Marretti Giacomo — P.IVA 07282350482</p>
          <p>Località Casaglia 3B, 50032 Borgo San Lorenzo (FI) — IT</p>
          <p>Codice CIN: IT048017B4UPQMRN5Z</p>
        </div>
